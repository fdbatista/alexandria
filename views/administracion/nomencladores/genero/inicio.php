...
use app\models\search\GeneroSearch;
...
<div class="genero-index">
    ...
    <p>
        <?= Html::tag('a', "<i class='fa fa-plus'></i> $textoBoton", ['class' => 'btn btn-success', 'href' => Url::toRoute('administracion/nomencladores/genero/crear')]) ?>
    </p>
    <?=
    GridView::widget([
        'summary' => '',
