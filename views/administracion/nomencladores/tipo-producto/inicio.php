...
/* @var $this View */
/* @var $searchModel TipoProductoSearch */
...
<div class="tipo-producto-index">
    ...
    <p>
        <?= Html::tag('a', "<i class='fa fa-plus'></i> $textoBoton", ['class' => 'btn btn-success', 'href' => Url::toRoute('administracion/nomencladores/tipo-producto/crear')]) ?>
    </p>
    <?=
    GridView::widget([
        'summary' => '',
