...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            ['activo', 'in', 'range' => [self::STATUS_ACTIVE, self::STATUS_INACTIVE]],
        ];
    }
    ...
    {
        return Yii::$app->security->validatePassword($password, $this->contrasenha);
    }
    ...
    public function esAdmin()
    {
        ...
        $rol_id = Yii::$app->user->identity->id_rol;
        return $rol_id === 2 || $rol_id === 3;
    }
