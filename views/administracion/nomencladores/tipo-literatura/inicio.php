...
/* @var $this View */
/* @var $searchModel TipoLiteraturaSearch */
/* @var $dataProvider ActiveDataProvider */

$this->title = 'Tipos de Literatura';
$this->menu_activo = 'suministrador';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="tipo-literatura-index">
    ...
    <p>
        <?= Html::tag('a', "<i class='fa fa-plus'></i> $textoBoton", ['class' => 'btn btn-success', 'href' => Url::toRoute('administracion/nomencladores/tipo-literatura/crear')]) ?>
    </p>
    <?=
    GridView::widget([
        'summary' => '',
