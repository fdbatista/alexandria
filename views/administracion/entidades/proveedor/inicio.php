...
<div class="almacen-index">
    ...
    <p>
        <?= Html::tag('a', "<i class='fa fa-plus'></i> $textoBoton", ['class' => 'btn btn-success', 'href' => Url::toRoute('administracion/entidades/proveedor/crear')]) ?>
    </p>
    <?=
    GridView::widget([
        'summary' => '',
