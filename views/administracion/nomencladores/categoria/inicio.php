...
/* @var $this View */
/* @var $searchModel CategoriaSearch */
...
<div class="categoria-index">
    ...
    <?php Url::remember(); ?>
    <p>
        <?= Html::tag('a', "<i class='fa fa-plus'></i> $textoBoton", ['class' => 'btn btn-success', 'href' => Url::toRoute('administracion/nomencladores/categoria/crear')]) ?>
    </p>
    <?=
    GridView::widget([
        'summary' => '',
